...
const Portfolio = () => {
  ...
  return (
    <div
      name="portfolio"
      className="pb-60 sm:px-2 lg:pb-80 h-fit sm:h-fit lg:h-screen w-full pt-16 lg:pt-24 sm:pt-24 sm:pb-24 flex flex-col bg-gradient-to-br from-[#124e66] to-[#124e66]"
    >
