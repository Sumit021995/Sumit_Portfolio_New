...
const Contact = () => {
  return (
    <div name="contact" className="h-screen px-10 pb-10 sm:px-2 w-full bg-gradient-to-br from-[#124e66] to-[#124e66]">
      <div className="flex flex-col p-4 sm:justify-center max-w-screen-lg mx-auto text-white font-bold">
        ...
        <div className="flex justify-center items-center">
            <form action="https://getform.io/f/lbjkrgoa" method="POST" className="flex flex-col w-full md:w-1/2">
                ...
                <button className="text-white bg-[#41BF61] px-6 py-10 mx-auto flex items-center rounded-md hover:scale-110 duration-300">Submit</button>
            </form>
        </div>
      </div>
    </div>
